...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // to disable h2-db and use mySQL db.
public class EmployeeRepositoryITest {
    ...
    public void givenEmployees_whenFindAll_thenEmployeeList() {
        ...
        assertThat(employees).hasSize(3).contains(employee);
    }
